...
public class CredentialPublicExtractServiceImpl extends BaseService implements CredentialPublicExtractService {
    ...
    private void writeAccess(CredentialExtractLinkEntity link,
        ...
        entity.setUserAgentHash(credentialCryptoService.sha256(userAgent));
        entity.setBrowser(deviceInfo.getBrowser());
        entity.setBrowserVersion(deviceInfo.getBrowserVersion());
        entity.setOsName(deviceInfo.getOsName());
        entity.setOsVersion(deviceInfo.getOsVersion());
        entity.setDeviceType(deviceInfo.getDeviceType());
        entity.setDeviceBrand(deviceInfo.getDeviceBrand());
