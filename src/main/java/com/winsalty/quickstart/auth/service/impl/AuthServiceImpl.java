...
public class AuthServiceImpl implements AuthService {
    ...
    public LoginResponse login(LoginRequest request) {
        ...
        log.info("user login success, username={}, roleCode={}", user.getUsername(), roleCode);
        return new LoginResponse(jwtTokenProvider.createToken(user.getId(), user.getUsername(), roleCode));
    }
